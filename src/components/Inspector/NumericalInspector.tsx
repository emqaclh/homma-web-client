...
const NumericalInspector = ({columnName, description}: NumericalInspectorProps) => {

    return(
        <VStack>
            <Text fontWeight='semibold'>{columnName}</Text>
            <Histogram labels={description!.c_labels} values={description!.c_values}/>
...
interface HistogramProps { labels: string[], values: number[]}
