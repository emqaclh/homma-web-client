...
import { Text, Center, Tooltip, Spinner, useColorModeValue, IconButton, Icon, Container, HStack, MenuButton, MenuList, MenuItem, Menu, Flex } from '@chakra-ui/react';
import { RiBookmark3Line, RiEyeOffLine, RiAlertLine, RiMoreFill, RiBarChartBoxLine, RiSeparator } from 'react-icons/ri';
...
const Feature = ({label, color, warning, mode='placeholder', isPrimary=false}: FeatureProps) => {
        ...
        >
            ...
            { mode=='hover' &&
                ...
                >
                    ...
                    >   
                        {isPrimary && 
                            <Icon as={RiBookmark3Line} marginLeft='0.4em' />
                        }
                        {warningBadge &&
