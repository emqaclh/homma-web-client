...
Categorical.args = {
    described: true, datatype: 'no-numerical', columnName: 'CATEGORICAL_COLUMN',
    description: {
        count: 58000000,
        distinct: 18,
        missing: 5498,
...
Numerical.args = {
    described: true, datatype: 'numerical', columnName: 'NUMERICAL_COLUMN',
    description: {
        count: 58000000,
        mean: 0.5,
        std: 0.332232355,
