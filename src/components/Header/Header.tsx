...
import { Center, Container, HStack, Icon, IconButton, Spinner, Text, useColorModeValue } from "@chakra-ui/react";
...
const Header = ({tag, color, mode}: HeaderProps) => {
    ...
    const mainText: string = mode === 'active' ? tag! : mode === 'placeholder' ? 'Add' : mode === 'loading' ? 'Loading...' : '...';
