...
const Inspector = ({described = true, descriptionRequested=false, columnName, datatype, description}: InspectorProps) => {
    ...
    return(
        <Container centerContent>
            {described ?
                datatype == 'numerical' ?
                    <NumericalInspector columnName={columnName} description={description}/>
                :   <CategoricalInspector columnName={columnName} description={description}/>
            :
            <VStack>
                <Text>
                    This feature has not been described yet!    
                </Text>
                <Button
